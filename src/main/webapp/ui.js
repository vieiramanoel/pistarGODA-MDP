...
new uiC.ButtonView({model: new uiC.ButtonModel({label: 'And-P-Refinement', action: ui.STATE_ADD_LINK, name: 'AndRefinementPararelLink', tooltip:'Add And-Paralel-Refinement link', statusText:'And-Refinement link: click first on the child, and then on the parent. It can only be applied to goals or tasks.'})}).render();
new uiC.ButtonView({model: new uiC.ButtonModel({label: 'Or-P-Refinement', action: ui.STATE_ADD_LINK, name: 'OrRefinementPararelLink', tooltip:'Add Or-Paralel-Refinement link', statusText:'Or-Refinement link: click first on the child, and then on the parent. It can only be applied to goals or tasks.'})}).render();
